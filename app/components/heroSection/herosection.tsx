...
const HeroSection: React.FC<HeroSectionProps> = ({ gamesList }) => {
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mb-5 mx-auto mt-5 p-6   bg-amber-50 rounded-3xl text-center flex flex-col items-center justify-center gap-6 ">
      <p className="text-3xl md:text-4xl font-bold text-gray-800"> 
        Looking for somethings <span className='text-red-700'>specific</span>?
      </p>
      <p className="text-gray-400 text-lg max-w-xl">
        Use our Advanced Search to filter games. Find exactly what you want in seconds!
      </p>
