...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body className="bg-gradient-to-br from-gray-950 via-black to-gray-900 text-white min-h-screen flex items-center justify-center px-6">
        <div className="max-w-2xl w-full text-center">

          {/* Glowing Title */}
          <h1 className="text-6xl md:text-7xl font-extrabold tracking-tight bg-gradient-to-r from-amber-400 via-orange-500 to-red-500 bg-clip-text text-transparent drop-shadow-[0_0_25px_rgba(251,191,36,0.6)]">
            GAME OVER
          </h1>
          ...
          {/* Divider line */}
          <div className="mt-8 h-px w-full bg-gradient-to-r from-transparent via-amber-500 to-transparent opacity-40" />
